...
# === STEP 3: Extract Structured Fields and Classify Document ===
...
- Date of Expiration
- Sex
Dont use "" for every cell.
Make sure that date of birth is in "02 Jul 1977" this format.
...
"""
    ...
    for num in numbers:
        if len(num) == 9:
            ...
            driving_license_number = num
        elif len(num) == 10:
            identity_card_number = num

    extracted_data["Passport Number"] = passport_number
    extracted_data["Driving License Number"] = driving_license_number
    extracted_data["Identity Card Number"] = identity_card_number

    return extracted_data

# === STEP 4: Display All Extracted Fields ===
def display_results(data):
    print("\nExtracted Document Details:")
    print(tabulate([[k, v] for k, v in data.items()], headers=["Field", "Value"], tablefmt="grid"))

# === STEP 5: Save All Required Fields to Excel ===
